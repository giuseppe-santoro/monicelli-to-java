...
blinda la supercazzola Sassaroli converge con
        vero Sassaroli, sogno Sassaroli, passo Necchi, destinazione 
        Sassaroli, finta Sassaroli o scherziamo?
        ...
        o tarapia tapioco:
            vaffanzum
                prematurata la supercazzola converge con
                    vero per vero meno un sogno per il sogno più la destinazione, 2
                    per il vero per il sogno più la finta, il 
                    passo più 1, destinazione, finta
                o scherziamo?!
    e velocità di esecuzione
...
blinda la supercazzola antanizzata con
        mino Sassaroli, mano Sassaroli, piede Sassaroli, fuochino
        Sassaroli, mono Sassaroli, pastene Sassaroli o scherziamo?
...
blinda la supercazzola cofandina con
        vero Sassaroli, l'immagine Sassaroli, la 
        grandezza Sassaroli, il finale Sassaroli bituma come sempre
        o scherziamo?
    prematurata la supercazzola antanizzata con 
        vero, vero più la grandezza per 78, grandezza, immagine, immagine
        più il finale per 40, il finale
    o scherziamo?
